...
public class Employee {
    ...
    public Employee(Long id, String name, Integer age, Boolean married, Double salary, Instant createDate, LocalDate birthDate, LocalDateTime registrationDate, List<String> email, EmployeeType category, Address address, Company company, List<Project> projects) {
        this.id = id;
        this.name = name;
        this.age = age;
